      ...
      >
        <nav className="mx-auto flex max-w-7xl items-center justify-between px-5 py-4 md:px-10" aria-label="Primary">
          ...
          <div className="hidden items-center gap-3 md:flex">
            <a
              className="focus-ring inline-flex items-center gap-2 rounded-full border border-bone/18 px-5 py-3 text-sm font-semibold text-bone/86 transition duration-300 hover:-translate-y-0.5 hover:border-moss/70 hover:text-bone"
              href={links.github}
              target="_blank"
              rel="noopener noreferrer"
            >
              <svg viewBox="0 0 24 24" width="16" height="16" fill="currentColor" aria-hidden="true">
                <path d="M12 .5C5.73.5.5 5.73.5 12c0 5.08 3.29 9.39 7.86 10.91.57.1.78-.25.78-.55 0-.27-.01-1.17-.02-2.12-3.2.7-3.88-1.36-3.88-1.36-.52-1.33-1.28-1.68-1.28-1.68-1.04-.72.08-.7.08-.7 1.15.08 1.76 1.18 1.76 1.18 1.03 1.75 2.69 1.25 3.34.96.1-.75.4-1.25.73-1.54-2.55-.29-5.24-1.28-5.24-5.69 0-1.26.45-2.28 1.18-3.09-.12-.29-.51-1.46.11-3.05 0 0 .96-.31 3.15 1.18a10.9 10.9 0 0 1 5.74 0c2.18-1.49 3.14-1.18 3.14-1.18.63 1.59.23 2.76.12 3.05.73.81 1.17 1.83 1.17 3.09 0 4.42-2.69 5.39-5.25 5.68.41.36.78 1.06.78 2.14 0 1.55-.01 2.79-.01 3.17 0 .3.2.66.79.55A10.53 10.53 0 0 0 23.5 12c0-6.27-5.23-11.5-11.5-11.5Z" />
              </svg>
              GitHub
            </a>
            ...
            >
              <svg viewBox="0 0 24 24" width="16" height="16" fill="currentColor" aria-hidden="true">
                <path d="M20.45 20.45h-3.56v-5.57c0-1.33-.02-3.04-1.85-3.04-1.85 0-2.14 1.45-2.14 2.94v5.67H9.35V9h3.42v1.56h.05c.48-.9 1.63-1.85 3.36-1.85 3.6 0 4.27 2.37 4.27 5.45v6.29ZM5.34 7.43a2.06 2.06 0 1 1 0-4.13 2.06 2.06 0 0 1 0 4.13ZM7.12 20.45H3.56V9h3.56v11.45ZM22.23 0H1.77C.79 0 0 .77 0 1.73v20.54C0 23.23.79 24 1.77 24h20.46c.98 0 1.77-.77 1.77-1.73V1.73C24 .77 23.21 0 22.23 0Z" />
              </svg>
              LinkedIn
            </a>
          </div>
        ...
        >
          <div className="flex flex-col gap-5">
            ...
            <a
              className="focus-ring mt-5 inline-flex items-center justify-center gap-2 rounded-full bg-bone px-6 py-4 text-center text-sm font-bold text-charcoal"
              href={links.linkedin}
              target="_blank"
              rel="noopener noreferrer"
              onClick={closeMenu}
            ...
            <a
              className="focus-ring inline-flex items-center justify-center gap-2 rounded-full border border-bone/20 px-6 py-4 text-center text-sm font-bold text-bone/86"
              href={links.github}
              target="_blank"
              rel="noopener noreferrer"
              onClick={closeMenu}
